                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  {voices.map((voice) => (
                    ...
                    >
                      <div
                        className={cn(
                          "p-6 border-2 rounded-xl flex flex-col items-center transition-all duration-300 bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm hover:shadow-lg",
                      ...
                      >
                        <div className="w-16 h-16 mb-4 rounded-full bg-gradient-to-br from-blue-400 to-cyan-300 flex items-center justify-center shadow-md">
                          <Button
                            variant="ghost"
                            size="icon"
                            className="w-12 h-12 rounded-full bg-white/80 hover:bg-white text-blue-600"
                        ...
                        <h3 className="mb-1 text-lg font-bold">{voice.label}</h3>
                        <p className="mb-4 text-sm text-gray-500 dark:text-gray-400">{voice.description}</p>
                        <Button
                          variant="default"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <motion.div variants={itemVariants} className="space-y-2">
                    ...
                    <Textarea
                      ...
                      required
                      className="min-h-[100px] bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 focus:border-cyan-500 rounded-xl transition-all"
                    />
                  </motion.div>
                  <motion.div variants={itemVariants} className="space-y-2">
                  ...
                  <motion.div variants={itemVariants} className="space-y-2">
                    <Label htmlFor="affirmation" className="text-base font-medium">
                    ...
                    <Input
                      ...
                      onChange={handleInputChange}
                      className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-2 focus:border-cyan-500 rounded-xl transition-all"
                    />
                  </motion.div>
                  <motion.div variants={itemVariants} className="flex justify-between pt-4">
                    <Button
                      ...
                      variant="ghost"
                      onClick={() => setStep(3)}
                      className="text-cyan-600 hover:text-cyan-700 hover:bg-cyan-50 dark:text-cyan-400 dark:hover:bg-cyan-900/20"
                    >
                      Back
                    </Button>
                    <Button
                    ...
                    <motion.div key="success" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
                      ...
                      >
                        <Button
                          ...
                          className="px-8 py-6 text-lg font-medium bg-gradient-to-r from-violet-500 to-indigo-500 hover:from-violet-600 hover:to-indigo-600 text-white shadow-lg rounded-xl"
                        >
                          <Sparkles className="w-5 h-5 mr-2" />
