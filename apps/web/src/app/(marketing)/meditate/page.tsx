...
export default function MeditatePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f2efea] to-white py-16 md:py-24">
      <div className="container px-4 md:px-6 max-w-7xl mx-auto">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-3xl md:text-4xl font-bold text-[#272401] mb-4 text-center">
            Create Your Personal Meditation
          </h1>
          <p className="text-[#557373] text-lg text-center mb-12">
