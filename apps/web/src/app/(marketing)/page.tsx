          ...
          <div className="max-w-4xl mx-auto text-center">
            <AnimateInView direction="up" className="space-y-6">
              ...
              <div className="flex justify-center pt-4">
                <Link href="/meditate">
                  <Button size="lg" className="bg-[#f2efea] text-[#557373] hover:bg-[#dfe5f3] hover:text-[#557373] transition-colors shadow-lg">
                    Start Your Journey <ArrowRight className="ml-2 size-4" />
                  </Button>
                </Link>
              </div>
              <p className="text-base text-[#f2efea]/80 pt-2">
            ...
            {categories.map((category, index) => (
              ...
              >
                <Link href={`/meditate?category=${category.id}`} className="w-full group">
                  <Button 
                    variant="outline" 
                    className="w-full h-auto py-4 px-3 rounded-md border border-[#557373]/20 bg-white hover:bg-[#dfe5f3]/50 group-hover:border-[#557373] group-hover:shadow-md transition-all duration-300 ease-in-out"
                  >
                    <div className="flex items-center gap-2">
                      <span className="text-[#557373] group-hover:text-[#557373] transition-colors duration-300">{category.icon}</span>
                      <span className="text-[#272401] group-hover:text-[#557373] text-base font-medium transition-colors duration-300">{category.name}</span>
                    </div>
                  </Button>
                </Link>
              </AnimateInView>
          ...
          <div className="mx-auto grid gap-8 md:grid-cols-3 md:gap-12 mt-12">
            <AnimateInView delay={0.1} className="flex flex-col items-center space-y-4 text-center">
              <div className="relative mb-4 flex size-20 items-center justify-center rounded-full bg-[#dfe5f3]">
                ...
                <span className="absolute -right-2 -top-2 flex size-8 items-center justify-center rounded-full bg-[#557373] text-white">
                  1
                </span>
              </div>
